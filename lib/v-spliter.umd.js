(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VUE_V_SPLITER = {}));
})(this, (function (exports) { 'use strict';

    exports.E_layout = void 0;
    (function (E_layout) {
        E_layout["auto"] = "auto";
        E_layout["horizontal"] = "horizontal";
        E_layout["vertical"] = "vertical"; //竖向
    })(exports.E_layout || (exports.E_layout = {}));
    ...
    var directive = function (el, binding) {
        ...
        var _value = { layout: exports.E_layout.auto };
        ...
        function testLayout() {
            ...
            if (value.layout == exports.E_layout.auto) {
                if (elRect.right > elNextRect.x) {
                    layout = exports.E_layout.vertical;
                }
                else {
                    layout = exports.E_layout.horizontal;
                    attr = 'width';
                }
            }
            if (layout == exports.E_layout.vertical) {
                attr = 'height';
        ...
        var onstart = function (event) {
            ...
            active = true;
            buttonDown = true;
            offsetStyle = layout == exports.E_layout.vertical ? preEl.getClientRects()[0].height : preEl.getClientRects()[0].width;
            offset = layout == exports.E_layout.vertical ? event.clientY : event.clientX;
        };
        var onmove = function (event) {
            if (active && buttonDown) {
                var preStyle = ((layout == exports.E_layout.vertical ? event.clientY : event.clientX) - offset + offsetStyle);
